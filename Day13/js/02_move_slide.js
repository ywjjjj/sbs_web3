...
$(function () {
    ...
    // <li> 요소들의 가로/세로 개수
    let slideWidth = item.width() // 슬라이드의 가로 크기
    let slideHeight = item.height() // 슬라이드의 세로 크기
    let slideCount = item.length // 슬라이드의 개수
    ...
    // - 앞으로 가져올 슬라이드 개수
    //  : 5 / 2 = 2.4, parseInt(2.5) --(정수만 가져오는)--> 2
